...
public class QuizRow {
    @JsonProperty("quiz_id") private Integer quizId;
    @JsonProperty("quiz_name") private String quizName;
    @JsonProperty("quiz_theme") private String quizTheme;
    ...
    @JsonProperty("max_points") private Integer maxPoints;
    @JsonProperty("created_at") private LocalDateTime createdAt;
    @JsonProperty("organizer_id") private Integer organizerId;
    @JsonProperty("location_id") private Integer locationId;
